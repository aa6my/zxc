...
<form action="" method="post" id="job_form">
    ...
    $fieldset_data = array(
        ...
        'elements' => array(
            ...
            'date_quote' => array(
                'title' => 'Quote Date',
	            'ignore' => !module_config::c('job_allow_quotes',1),
                'field' => array(
                    'type' => 'date',
                    'name' => 'date_quote',
    ...
    // files
    if(class_exists('module_files',false)) {
	    ob_start();
    ...
    if(module_job::can_i('view','Job Advanced')){
	    ...
	    if ( (int) $job_id > 0 && class_exists( 'module_import_export', false ) && module_import_export::is_plugin_enabled() ) {
		    $fieldset_data['elements'][] = array(
			    'title'  => 'Task CSV Data',
			    'fields' => array(
