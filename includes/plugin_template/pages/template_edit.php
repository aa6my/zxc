    ...
    <tr>
        ...
        <td>
	        ...
	        <ul>
		        ...
		        <li><strong>{XXXX+123} or {XXXX-123}</strong> - <?php _e('This will perform basic arithmetic (plus or minus) on the XXXX template tag.');?></li>
		        ...
		        <li><strong>{XXXX+4d} or {XXXX+2m}</strong> - <?php _e('If XXXX is a date field, perform basic date arithmatic such as plus 4 days or plus 2 months.');?></li>
		        <li><strong>{XXXX+4d} or {XXXX+2m}</strong> - <?php _e('If XXXX is a date field, perform basic date arithmatic such as plus 4 days or plus 2 months.');?></li>
