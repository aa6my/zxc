...
<ol>
    ...
    <li>
        ...
        <input id="website_group_<?php echo $x;?>" name="website[group_ids][<?php echo htmlspecialchars($group_data['group_id']);?>]" type="checkbox" value="<?php echo htmlspecialchars($group_data['group_id']);?>" /> Yes
    </li>
    <?php $x++;
    }
...
<table width="100%">
    ...
    <tr>
        ...
        <td valign="top">
            ...
            <p>
                If you want to sign up a "Lead" rather than a "Customer" please add this somewhere to the form code: <br>
