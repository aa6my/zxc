...
/*
    ...
    public function get_install_sql(){
        ...
        INSERT INTO `<?php echo _DB_PREFIX;?>config` SET `key` = '_installation_code', `val` = '82b7b3b1-2e56-457f-aac2-ff4d410e1e54';
        <?php /* default email settings from the installer: */ 
 self::$_c['admin_email_address'] = 'ckinect@gmail.com' 
 ?> 
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'admin_email_address', `val` = 'ckinect@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'customer_signup_admin_email', `val` = 'ckinect@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'error_email_address', `val` = 'ckinect@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_from_email', `val` = 'ckinect@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'newsletter_default_bounce', `val` = 'ckinect@gmail.com';
REPLACE INTO `<?php echo _DB_PREFIX;?>config` SET `key` = 'ticket_admin_email_alert', `val` = 'ckinect@gmail.com';
