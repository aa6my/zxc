...
if(isset($_POST['bulk_remove_priority']) && $_POST['bulk_remove_priority'] == 'go'){
    ...
    foreach($invoices as $invoice){
        ...
        if($invoice_check['total_amount_paid']<=0){
            // remove this invoice
            echo "Deleting invoice ".$invoice['name']." for ".dollar($invoice_check['total_amount_due'],true,$invoice['currency_id'])." from ".print_date($invoice['date_create']). " and ticket  ".module_ticket::link_open($invoice['ticket_id'],true)." <br>\n";
